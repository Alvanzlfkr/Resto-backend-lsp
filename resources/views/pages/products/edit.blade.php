                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectric @error('category_id') is-valid @enderror"
                                name="category_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100"></div>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="is_available" value="1"
                                            class="selectgroup-input" {{ $product->is_available ? 'checked' : '' }}>
                                    ...
                                    <div class="selectgroup w-100"></div>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="is_favorite" value="1"
                                                class="selectgroup-input" {{ $product->is_favorite ? 'checked' : '' }}>
